# -*- coding: utf-8 -*-
"""
Created on Sun Nov 20 19:25:06 2022
...
# code parts copied from https://radiusofcircle.blogspot.com/2016/06/problem-54-project-euler-solution-with-python.html

import requests
from collections import Counter

data = requests.get("https://projecteuler.net/project/resources/p054_poker.txt").text
two_hands = data.strip().split('\n')
